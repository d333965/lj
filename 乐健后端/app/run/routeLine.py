...
def getRouteLine(schoolName, rounds):
    ...
    elif schoolName == '川农雅安老校区':
        routineLine_Data = schoolRoutes.川农雅安老校区
    ...
    elif schoolName == '攀枝花西苑':
        routineLine_Data = schoolRoutes.攀枝花西苑
    elif schoolName == '西南交通九里':
        routineLine_Data = schoolRoutes.西南交通九里
    elif schoolName == '西南交通犀浦':
        routineLine_Data = schoolRoutes.西南交通犀浦
    else:
