...
import base64
###############跑步任务
def runTask( day_goals, accessToken, semesterId, routine_line,runType,OctSecretKey,n,rounds):
        ...
        if rounds == 5:
            random_number_avePace = random.randint(500000, 580000) #改配速7`30~8`50
        else:
            random_number_avePace = random.randint(460000, 520000) #改配速7`30~8`50
