...
def runTask( day_goals, accessToken, semesterId, routine_line,runType,OctSecretKey,n):
        ...
        random_number_avePace = random.randint(430000, 520000) #改配速7`30~8`40
        ...
        current_datetime = current_datetime - timedelta(days=n,minutes=random.randint(5,55))  # 补跑前面第几天的
