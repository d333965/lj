...
import base64
###############跑步任务
def runTask( day_goals, accessToken, semesterId, routine_line,runType,OctSecretKey,n):
        ...
        random_number_avePace = random.randint(430000, 530000) #改配速7`30~8`50
        ...
        random_paceNumber = random_number_keepTime*random.randint(80,144)/60
        ...
        current_datetime = current_datetime - timedelta(days=n,hours=3,minutes=random.randint(10,55))  # 补跑前面第几天的
        ...
        signTime_ago = endtime_as_datetime + timedelta(seconds=(keepTime % 11))
        # 格式化前10分钟的时间，包括秒数
