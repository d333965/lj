    ...
    <el-form ref="form" :model="subForm" :rules="rules" size="large" class="center-form" style="width: 100%;">
      ...
      <el-form-item label="学校" prop="schoolName">
        <el-select v-model="subForm.schoolName" placeholder="请选择">
          ...
          <el-option label="西油成都" value="西油成都"@click="subForm.day_goals='2.4',subForm.day_in_week='6'"></el-option>
          <el-option label="西油南充" value="西油南充" @click="subForm.runType = '定点跑',subForm.rounds = '1',subForm.day_goals='2.4',subForm.day_in_week='6'"></el-option>
          ...
          <el-option label="轻化工李白河" value="轻化工李白河" @click="subForm.day_goals='3',subForm.day_in_week='7'"></el-option>
          <el-option label="轻化工汇南" value="轻化工汇南" @click="subForm.day_goals='3',subForm.day_in_week='7'"></el-option>
          <el-option label="轻化工宜宾" value="轻化工宜宾" @click="subForm.day_goals='3',subForm.day_in_week='7'"></el-option>
          ...
          <el-option label="四川卫康" value="四川卫康" @click="subForm.day_goals='4',subForm.day_in_week='4',subForm.runTime='21~24'"></el-option>
